...
class CreateVatTaxTransactionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('vat_tax_transactions', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('vat_tax_transactions');
    }
}
